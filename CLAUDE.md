...
- **continuous-audio-transcription**: 24時間連続音声文字起こしシステム (BlackHole + Whisper.cpp) - 旧アーキテクチャ
...
- `testing.md`: Always included - Testing strategy, TDD principles, and test patterns
